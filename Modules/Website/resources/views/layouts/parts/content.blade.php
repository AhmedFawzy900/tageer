        ...
        <section class="home__about">
            <div class="container">
                <div class="row">
                    @if($content->image)
                    <div class="col-lg-6">
                        <img loading="lazy" width="550" height="350" alt="{{$content->title}}" src="{{url('/')}}/storage/{{$content->image}}" />
                    </div>
                    @endif
                    <div class="col-lg-6">
        ...
        <section class="home__about">
            <div class="container">
                <div class="row">
                    @if($content->image_2)
                    <div class="col-lg-6">
                        <img loading="lazy" width="550" height="350" alt="{{$content->title_2}}" src="{{url('/')}}/storage/{{$content->image_2}}" />
                    </div>
                    @endif
                    <div class="col-lg-6">
                        <div class="home__about_content">
        ...
        <section class="home__about">
            <div class="container">
                <div class="row">
                    @if($content->image_3)
                    <div class="col-lg-6">
                        <img loading="lazy" width="550" height="350" alt="{{$content->title_3}}" src="{{url('/')}}/storage/{{$content->image_3}}" />
                    </div>
                    @endif
                    <div class="col-lg-6">
                        <div class="home__about_content">
