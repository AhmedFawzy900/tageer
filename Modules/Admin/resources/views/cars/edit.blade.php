                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-sm-10">
                                                    <input value="{{$car->engine_capacity}}"  type="text" required  class="form-control" name="engine_capacity" >
                                                </div>
                                            </div>  
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-sm-10">
                                                    <input value="{{$car->doors}}"  type="number" required  class="form-control" name="doors" >
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-sm-10">
                                                    <input value="{{$car->bags}}"  type="number" required  class="form-control" name="bags" >
                                                </div>
                                            </div>  
                                           @endif
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-sm-10">
                                                    <input value="{{$car->passengers}}" type="number" required  class="form-control" name="passengers" >
                                                </div>
                                            </div>     
