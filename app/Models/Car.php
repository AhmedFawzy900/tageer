...
class Car extends Model implements Sitemapable
{
    ...
    public function getDescription() {
        ...
        $carDescription   = __('lang.Rent') . " " . $this->name . " " . $this->model->title . " " .   $this->year->title . " " .  $this->color->title . " " . __('lang.Color') . " " . __('lang.Contact') . " " . $this->company->name . " " . __('lang.For Booking');
